    ...
    return (
        <List>
            ...
            >
                <OutlinedInput
                    id="outlined-search"
                    placeholder={language['studio.assetFilter.search.placeholder'] as string}
                    size="small"
                    type="search"
                    color="primary"
                    notched
                        ...
                        <AccordionSummary>
                            <Box width="100%" display="flex" justifyContent="space-between">
                                <Typography fontSize="1.2rem" fontWeight="700">
                                    {language['studio.assetFilter.context'] as ReactNode}
                                </Typography>
                ...
                <Box paddingBlock={2}>
                    <Accordion expanded={expandedTaxonomy} onChange={() => setExpandedTaxonomy(!expandedTaxonomy)}>
                        <AccordionSummary>
                            <Box width="100%" display="flex" justifyContent="space-between">
                                <Typography fontSize="1.2rem" fontWeight="700">
                                    {language['studio.assetFilter.taxonomy'] as ReactNode}
                                </Typography>
                ...
                <Box paddingBlock={2}>
                    <Accordion expanded={expandedCreators} onChange={() => setExpandedCreators(!expandedCreators)}>
                        <AccordionSummary>
                            <Box width="100%" display="flex" justifyContent="space-between">
                                <Typography fontSize="1.2rem" fontWeight="700">
                                    {language['studio.assetFilter.creators'] as ReactNode}
                                </Typography>
