...
import { increment, decrement, deleteCart } from '@/features/ecommerce/slice';
...
const AddToCart = () => {
    ...
    // Get Products
    const Cartproduct: ProductType[] = useSelector((state) => state.ecommerce.cart);
    ...
    return (
        <Box>
            {Cartproduct.length > 0 ? (
                <>
                    <Box>
                        <TableContainer sx={{ minWidth: 200, overflowX: 'auto' }}>
                            <Table>
                                <TableHead>
                                    <TableRow>
