...
import CustomCheckbox from '@/app/forms/CustomCheckbox';
import { ProductType } from '../types';
import CustomSwitch from '@/app/forms/CustomSwitch';
...
const ProductTableList = () => {
    ...
    const getProducts: ProductType[] = useSelector((state) => state.ecommerce.products);
                                                        ...
                                                        <Box
                                                            sx={{
                                                                backgroundColor: row.stock
                                                                    ? (themeParams) => themeParams.palette.success.main
                                                                    : (themeParams) => themeParams.palette.error.main,
                                                                borderRadius: '100%',
                                                                height: '10px',
                                                                width: '10px',
                                                            }}
