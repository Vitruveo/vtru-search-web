...
const ProductsData = [
    ...
    },
    {
        ...
        id: 2,
        created: sub(new Date(), { days: 10, hours: 8, minutes: 69 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
    ...
    },
    {
        ...
        id: 4,
        created: sub(new Date(), { days: 4, hours: 9, minutes: 40 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
        ...
        id: 5,
        created: sub(new Date(), { days: 2, hours: 5, minutes: 50 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
        ...
        id: 6,
        created: sub(new Date(), { days: 2, hours: 9, minutes: 45 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
        ...
        id: 7,
        created: sub(new Date(), { days: 6, hours: 10, minutes: 0 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
        ...
        id: 8,
        created: sub(new Date(), { days: 7, hours: 5, minutes: 20 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
    ...
    },
    {
        ...
        id: 10,
        created: sub(new Date(), { days: 6, hours: 6, minutes: 20 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
        ...
        id: 11,
        created: sub(new Date(), { days: 1, hours: 6, minutes: 20 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
    {
        ...
        id: 12,
        created: sub(new Date(), { days: 9, hours: 6, minutes: 20 }).toString(),
        description: chance.paragraph({ sentences: 2 }),
    },
];
